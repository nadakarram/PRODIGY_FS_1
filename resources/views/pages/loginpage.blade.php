            ...
            <div class=" w-50 h-100 d-flex justify-content-center align-content-center align-items-center">
                <div class="container px-5 py-5 rounded-3 shadow" style="">
                    <div class="form" >
                        ...
                        <h3 class="display-6 fw-bold text-dark">Welcome back 👋</h3>
                        ...
                        <div class="mt-2 d-flex  justify-content-center">
                            ...
                            <a href="/signup" class="text-success">Sign up</a>
                        </div>
                        <div class="mt-1 d-flex  justify-content-center">
                            <p>you can </p>
                            <a href="/adminlogin" class="text-decoration-underline text-success"> join as admin</a> or <a href="/technicallogin" class="text-success">technical</a>
                        </div>
